...
> ??????privacy-policy-template.docx ? ?????2026-08-05
> ??????????????????????????

温馨提示

欢迎您使用归星物语！我们非常重视保护您的个人信息和隐私。您可以通过《归星物语隐私政策》了解我们收集、使用、存储用户个人信息的情况，以及您所享有的相关权利。请您仔细阅读并充分理解相关内容：

为向您提供游戏服务，我们将依据《归星物语隐私政策》收集、使用、存储必要的信息。

基于您的明示授权，我们可能会申请开启您的网络设备权限，您有权拒绝或取消授权。
...
请您阅读完整版《归星物语用户协议》及《归星物语隐私政策》了解详细信息。

如您同意《归星物语用户协议》及《归星物语隐私政策》，请您点击“同意”开始使用我们的产品和服务，我们将尽全力保护您的个人信息安全。
...
归星物语开发组（注册地址：【请补充运营主体注册地址】，以下简称“我们”）系移动应用程序“归星物语”（以下简称“归星物语”）的运营者。我们非常重视保护用户（以下简称“您”）的个人信息和隐私。您在使用归星物语时，我们会收集、使用、保存、共享您的相关个人信息。为呈现我们处理您个人信息的情况，我们特制定《归星物语隐私政策》（以下简称“隐私政策”），我们承诺严格按照本隐私政策处理您的个人信息。

我们在此提醒您：

在您使用归星物语前，请您务必认真阅读本隐私政策，充分理解各条款内容，包括但不限于免除或限制我们责任的条款。您知晓并确认，您勾选“同意”本隐私政策并使用归星物语，就表示您同意我们按照本隐私政策处理您的个人信息。请您知悉，本政策仅适用于我们通过归星物语向您提供服务所收集的信息，不适用于通过接入归星物语以向您提供产品或服务的第三方所收集的信息。
...
在您使用归星物语过程中，我们会按照如下方式收集您的个人信息：

完成注册

当前版本未提供账号注册功能，您无需注册即可使用游戏，我们不会收集您的手机号码、登录密码等注册信息。

游戏服务

当您使用游戏服务时，您的游戏进度与存档仅保存在您的设备本地（浏览器本地存储），我们不会收集、上传您的游戏数据或设备信息。

实名认证

当前版本未提供实名认证功能，不收集您的姓名、身份证件等信息。如后续版本依据相关法规接入实名认证，我们将依照法律规定收集必要信息，并及时更新本政策。

保障网络和服务的安全

当前版本为本地单机游戏，无联网对战或在线服务，我们不收集您的设备识别符、IP地址、访问日期和时间等信息。

充值消费

当前版本未提供充值消费功能，不收集任何支付信息。

设备权限调用情况

在您使用归星物语过程中，我们需要在必要范围内向您申请获取设备权限。请您知悉，我们不会默认开启您设备的权限，仅在您主动确认开启的情况下，归星物语才有可能通过设备权限收集您的信息。归星物语调用的权限、调用权限的目的，以及调用权限前向您询问的情况请见下表：
...
本游戏为本地单机运行，不使用 Cookie 或任何跟踪技术。游戏存档通过浏览器本地存储（localStorage）保存在您的设备上，由您自行管理，我们不会读取或上传该数据。

（当前版本不使用上述 Cookie。）

当前版本未接入第三方跟踪技术，不存在第三方通过 Cookie 或同类技术收集您信息的情形。

如果您的浏览器允许，您可以在浏览器设置中管理或清除本地存储数据；清除后游戏存档可能丢失，请您知悉。

本地存档说明

游戏存档仅保存在您的设备本地，不会同步到任何服务器。
...
当前版本无账号系统、无广告及统计合作，我们不向任何业务合作伙伴共享您的个人信息。
...
当前版本未接入任何第三方广告、统计或数据分析 SDK。我们使用 Capacitor 将游戏打包为移动应用，其在本机系统层运行，不收集您的个人信息。
...
在您使用归星物语期间，您可以通过相应页面提示或本隐私政策载明的方式联系我们，以访问、更正、删除您的个人信息，以及行使改变授权同意的范围与注销账号的权利，您的意见会及时得到处理。

访问及更正您的个人信息

当前版本无账号系统，游戏中不存在可访问或更正的注册类个人信息；如您对本地存档有疑问，可通过本政策载明的方式与我们联系。
...
请您理解，归星物语可能需要开启部分权限并收集必要的个人信息才能得以实现。当您撤回您的同意时，我们将无法继续为您提供撤回同意所对应的服务，但不会影响此前基于您的授权而开展的个人信息处理服务。

注销账户

当前版本未提供账户功能，无需注销；如您希望删除本地存档数据，可卸载应用或在应用管理中清除数据。
...
如果您对本政策或个人信息保护有任何问题，可以通过以下方式与我们联系：
名称：归星物语开发组
地址：【请补充运营主体注册地址】
联系邮箱：【待补充】
联系电话：【待补充】
...
|---|---|---|---|
| 网络 | 保障游戏基础功能运行（当前版本为本地单机，权限预留） | 是 | 可 |

| SDK名称 | SDK使用目的 | SDK收集的信息 | 隐私政策链接 |
|---|---|---|---|
| 无 | 当前版本未接入第三方 SDK | 不收集 | — |
