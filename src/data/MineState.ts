...
export const ORE_DEPOSITS: OreDeposit[] = [
  // 石头矿脉（3处，灰色）
  { id: 's1', oreType: 'stone', col: 6, row: 5, staminaCost: 5, color: 0x9e9e9e, drops: [{ item: 'stone', count: 3 }] },
  ...
  // 铁矿矿脉（1处，银白色，稀有）
  { id: 'i1', oreType: 'iron', col: 24, row: 14, staminaCost: 15, color: 0xc0c0c0, drops: [{ item: 'iron', count: 1 }] },
];
